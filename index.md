...
venue: "<h1>Introduction to Python - Software Carpentry</h1> <br><br> CQ University Australia"        # brief name of host site without address (e.g., "Euphoric State University")
