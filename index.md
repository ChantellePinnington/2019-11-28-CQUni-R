...
humandate: "February 28 - March 01, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
<p>
 ...
 <p>
  You must attend both days, unless otherwise confirmed with the instructor.  With this training provide online using ZOOM, places are very limited.  With this in mind, <b>if you register to attend and then don’t attend the full training, you will forfeit any other training provided by CQUniversity eResearch Support for the remaining of the year.</b>  Obviously, if there are extenuating circumstances, then they will be considered.
</p>
...
<h2 id="setup">Lesson Details: Python Programming </h2>
  ...
  <p>Setup information: <a href="http://swcarpentry.github.io/python-novice-gapminder/setup/">http://swcarpentry.github.io/python-novice-gapminder/setup/ <br>
Please note that we will not using Jupyter notebook, instead we will be using the “spyder” interactive development environment, as it more user friendly and already come as part of an anaconda installation.</a></p>
